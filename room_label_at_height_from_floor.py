...
-
    ...
    Args:
        ...
        elevation: An optional height from the room's floor at which to display the label. Default 1 meter.
...
if all_required_inputs(ghenv.Component):
    ...
    for room in rooms:
        ...
        cent_pt = Point3D(room.geometry.center.x, room.geometry.center.y, room.geometry.min.z + elevation)  # base point for the text
